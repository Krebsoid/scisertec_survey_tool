...
public class Question6_1Bean implements Question6_1 {

    Map<String, Number> results = new LinkedHashMap<String, Number>();
    Set<Sheet> sheets;

    public Question6_1Bean(Set<Sheet> sheets) {
        this.sheets = sheets;
        collectResults();
    }
    ...
    public void collectResults() {
        ...
        for(Sheet sheet : sheets) {
            ...
            if(question6_1 != null) {
                if(question6_1.data().equals(1)) {
                    yes++;
                }
                else if(question6_1.data().equals(1)) {
                    no++;
                }
                else {
                    dontknow++;
